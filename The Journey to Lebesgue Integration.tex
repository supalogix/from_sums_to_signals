...
%\subimport*{section/13_stevin}{stevin.tex}
%\subimport*{section/14_copernicus}{copernicus.tex}
%\subimport*{section/15_galileo}{galileo.tex}
%\subimport*{section/16_kepler}{kepler.tex}
%\subimport*{section/17_cavalieri}{cavalieri.tex}
%\subimport*{section/18_wallis}{wallis.tex}
%\subimport*{section/19_barrow}{barrow.tex}
%\subimport*{section/20_newton}{newton.tex}
%\subimport*{section/21_leibniz}{leibniz.tex}
%\subimport*{section/22_euler}{euler.tex}
%\subimport*{section/23_lagrange}{lagrange.tex}
%\subimport*{section/24_laplace}{laplace.tex}
%\subimport*{section/25_hamilton}{hamilton.tex}
%\subimport*{section/26_riemann}{riemann.tex}
%\subimport*{section/27_heavyside}{heavyside.tex}
%\part{Analysis}
%\subimport*{section/28_cauchy}{cauchy.tex}
%\subimport*{section/29_fourier}{fourier.tex}
%\subimport*{section/30_riemann}{riemann.tex}
%\subimport*{section/31_weierstrass}{weierstrass.tex}
%\subimport*{section/32_dedekind}{dedekind.tex}
%\subimport*{section/33_cantor}{cantor.tex}
%\subimport*{section/34_borel}{borel.tex}
%\subimport*{section/35_lebesgue}{lebesgue.tex}
%\part{Probability and Statistics}
%\subimport*{section/36_kolmogorov}{kolmogorov.tex}
%\subimport*{section/37_fisher}{fisher.tex}
%\subimport*{section/38_shannon}{shannon.tex}
%\subimport*{section/39_kullback_and_leibler}{kullback_and_leibler.tex}
%\subimport*{section/40_jeffries}{jeffries.tex}
%\subimport*{section/41_jordan}{jordan.tex}
%\subimport*{section/42_amari}{amari.tex}
%\part{Mathematical Foundations}
%\subimport*{section/43_godel}{godel.tex}
%\subimport*{section/44_mckay}{mckay.tex}
%\subimport*{section/45_hoeffding}{hoeffding.tex}
%\subimport*{section/46_wittgenstein}{wittgenstein.tex}
%\subimport*{section/47_chaitin}{chaitin.tex}
%\part{Computation}
%\subimport*{section/48_turing}{turing.tex}
%\subimport*{section/49_shannon}{shannon.tex}
%\subimport*{section/50_von_neumann}{von_neumann.tex}
%\subimport*{section/51_ulmann}{ulmann.tex}
%\subimport*{section/52_nash}{nash.tex}
%\subimport*{section/53_pontryagin}{pontryagin.tex}
%\subimport*{section/54_rossenblatt}{rossenblatt.tex}
%\subimport*{section/55_minskey}{minskey.tex}
%\subimport*{section/56_hinton}{hinton.tex}
%\subimport*{section/57_hopfield}{hopfield.tex}
%\subimport*{section/58_sejnowski}{sejnowski.tex}
%\subimport*{section/59_yann_lecun}{yann_lecun.tex}
%\subimport*{section/60_hinton}{hinton.tex}
%\subimport*{section/61_hochreiter}{hochreiter.tex}
%\subimport*{section/62_alexnet}{alexnet.tex}
%\subimport*{section/63_harris}{harris.tex}
%\subimport*{section/64_vaswani}{vaswani.tex}
%\subimport*{section/65_yann_lecun}{yann_lecun.tex}
%\subimport*{section/66_shwartz}{shwartz.tex}
